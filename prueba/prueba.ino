...
void loop()
{
    ...
    /*double differential = ball_angle_180 * 0.3;
    ...
    // double new_ponderated_angle = fmod((ponderated_angle + 360.0), 360.0);

    // double speed_t_ball = pid_t_ball.Calculate(180 - ball_angle, ball_angle);

    /*Serial.print("Ball Angle Original:");
    ...
    if (ball_found)
    {
        ...
        /*Serial.print("ponderated angle: ");
        Serial.println(ponderated_angle);
        Serial.print("ball angle 180°: ");
