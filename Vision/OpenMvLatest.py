...
thresholds_blob1 =  (16, 100, 12, 127, -11, 127)      #(100, 72, 4, 127, 0, 94)   #(22, 81, 50, 75, -25, 74) (22, 81, 50, 70, -10, 24)
...
def locate_blob(img):
    ...
    #img.draw_circle(FRAME_HEIGHT+3, FRAME_WIDTH-5, FRAME_CIRCLE, color=0x0000, fill=False, thickness=20)
