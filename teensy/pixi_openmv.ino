...
thresholds_blob1 =  (45, 56, 35, 66, 16, 65)          #(100, 72, 4, 127, 0, 94)   #(22, 81, 50, 75, -25, 74) (22, 81, 50, 70, -10, 24)
thresholds_blob2 = (56, 75, -11, 16, 35, 72)        #(80, 89, -18, 6, 19, 127)
...
def locate_blob(img):
    ...
    img.draw_circle(FRAME_HEIGHT+3, FRAME_WIDTH-5, FRAME_CIRCLE, color=0x0000, fill=False, thickness=85)
