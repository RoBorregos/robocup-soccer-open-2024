/*Code for testing communication and feedback bewtween camera (ball angle) and IMU (Frame angle)*/
/*The robot follows the ball in its own axis with a PID controller (with IMU feedback) for the track of the ball*/
...
double ki = 3.15;
double kd = 0.25;
double previous_target_angle = 0;
double target_angle = 0; //Ball Angle
double last_error = 0;
double all_error = 0;
double new_error = 0;
double max_error = 10;
...
void loop()
{
    ...
    Serial.print(bno_angle); Serial.print(" ");
    Serial.print(cam_angle); Serial.print(" ");
   ...
   // PID & Motor Control
    ...
    new_error = target_angle - bno_angle;
