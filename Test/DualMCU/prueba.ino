...
void loop()
{
    ...
    if (Serial1.available() > 0)
    {
        ...
        double distance_pixels_protect = values[5];
        Serial.print("distance_pixels_protect");
        Serial.println(distance_pixels_protect);
        /*
        Serial.print("Angle: ");
        Serial.println(bno_angle);
        Serial.print("Ball Distance ");
        ...
        */
        ...
        if (speed_w != 0 && distance_pixels > 90 || distance_pixels == 0 && distance_pixels_protect > 90 || distance_pixels_protect == 0)
        {
            ...
            if(distance_pixels == 0){
              goal_blue_found = false;
            }else{
              goal_blue_found = true;
            }
            ...
            //
                ...
                else if(distance_pixels != 0)
                {
                    myMotors.MoveMotorsImu(180, 150, speed_w);
                    delay(300);
                    myMotors.StopMotors();
                }else if(distance_pixels_protect != 0){
